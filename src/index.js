...
import {TransactionsServicePromiseClient} from './client/transactions/transactions_grpc_web_pb.js';
...
const transactionsService = new TransactionsServicePromiseClient(transactionsServicesAddr);
